                                    ...
                                    <div class="sort-by-cover">
                                        ...
                                        <div class="sort-by-dropdown">
                                            <ul>
                                                ...
                                                <li><a class="{{$orderBy== 'Newness' ? 'active': ''}}" href="#" wire:click.prevent="changeOrderBy('Newness')">Newness</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="pagination-area mt-15 mb-sm-5 mb-lg-0">
                                ...
                                <!-- <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-start">
                                        <li class="page-item"><a class="page-link" href="{{ $products->links() }}"><i class="fi-rs-angle-double-small-right"></i></a></li>
                                    </ul>
                                </nav> -->
                            </div>
                        </div>
