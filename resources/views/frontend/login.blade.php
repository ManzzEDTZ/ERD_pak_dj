...
@section('content')
    ...
    <body>
        ...
        <div class="box-form">
          <div class="left">
            <div class="overlay d-flex flex-column justify-content-between align-items-center">
              <div class="text-center">
                <h2>Welcome Back!</h2>
              </div>
              <div class="text-center">
                <img src="{{ asset('assets/image/young man sitting with a laptop and waving his hand.png') }}" alt="Logo-Ruscation">
              </div>
            ...
            <div class="right">
                ...
                <div class="login-with d-flex justify-content-between">
